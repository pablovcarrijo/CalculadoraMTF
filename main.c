...
int main(void)
{
    ...
    do {
        ...
        case 1:
            ...
            printf("\nJuros (J): %.4f\n", resultado);
            printf("Taxa usada no calculo: %.4f%% ao dia\n", i * 100.0);
            printf("Tempo usado no calculo: %.4f dias\n", n);
            pausar();
            break;
        ...
        case 6:
            ...
            if (1.0 - ic * n == 0.0) {
                ...
                printf("\nTaxa efetiva diaria (i): %.4f%% ao dia\n", resultado * 100.0);
                printf("Tempo usado no calculo: %.4f dias\n", n);
            }
        ...
        case 7:
            ...
            if (1.0 + i * n == 0.0) {
                ...
                printf("\nTaxa de desconto comercial diaria (ic): %.4f%% ao dia\n", resultado * 100.0);
                printf("Tempo usado no calculo: %.4f dias\n", n);
            }
